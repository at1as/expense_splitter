...
ActiveRecord::Schema.define(version: 20180328043233) do
  ...
  create_table "expenses", force: :cascade do |t|
    ...
    t.index ["purchaser_id"], name: "index_expenses_on_purchaser_id"
  end
  ...
  add_foreign_key "expenses", "people", column: "purchaser_id"
